   ...
   public int loadAvailableSchedules(int routeID, String travelDate) {
        try {
            ...
            while (rs.next()) {
                ...
                sch.departureTime = rs.getTimestamp("departure_time");  // FIXED: changed from getString to getTimestamp
                sch.arrivalTime = rs.getTimestamp("arrival_time");      // FIXED: changed from getString to getTimestamp
