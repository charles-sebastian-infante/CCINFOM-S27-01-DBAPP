...
public class ReportService {
    ...
    public static Map<String, Object> getDailyScheduleByTerminal(int terminalID, String date) {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            String departQuery = "SELECT s.schedule_id, s.bus_id, b.bus_number, r.route_id, r.route_name, " +
            ...
            String arriveQuery = "SELECT s.schedule_id, s.bus_id, b.bus_number, r.route_id, r.route_name, " +
    ...
    public static Map<String, Object> getDailyScheduleAllTerminals(String date) {
        Map<String, Object> report = new HashMap<>();
        Map<String, Map<String, Object>> terminalData = new LinkedHashMap<>();
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            for (Terminal terminal : terminals) {
                Map<String, Object> terminalReport = new HashMap<>();
                List<Map<String, Object>> schedules = new ArrayList<>();
                int totalDepartures = 0;
                int totalArrivals = 0;

                // Get departures from this terminal
                String departQuery = "SELECT s.schedule_id, s.bus_id, b.bus_number, r.route_id, r.route_name, " +
                        "t2.terminal_name as destination, s.departure_time, s.arrival_time, s.status, " +
                        "COUNT(tk.ticket_id) as passenger_count " +
                        "FROM Schedule s " +
                ...
                try (PreparedStatement departStmt = conn.prepareStatement(departQuery)) {
                    departStmt.setInt(1, terminal.terminalID);
                    departStmt.setString(2, date);
                ...
                try (PreparedStatement arriveStmt = conn.prepareStatement(arriveQuery)) {
                    arriveStmt.setInt(1, terminal.terminalID);
                    arriveStmt.setString(2, date);
                ...
                terminalReport.put("terminal_name", terminal.terminalName);
                terminalReport.put("schedules", schedules);
                terminalReport.put("total_departures", totalDepartures);
                terminalReport.put("total_arrivals", totalArrivals);

                terminalData.put(terminal.terminalName, terminalReport);
            }

        } catch (SQLException e) {
            System.err.println("Database error in getDailyScheduleAllTerminals: " + e.getMessage());
            e.printStackTrace();
        }

        report.put("date", date);
        report.put("terminals", terminalData);
    ...
    public static Map<String, Object> getRouteUsageAnalysis(int year, int month) {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            String query = "SELECT r.route_id, r.route_name, t1.terminal_name as origin, " +
    ...
    public static Map<String, Object> getMaintenanceCostReport(int year, int month) {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            String query = "SELECT DATE(m.starting_date) as maintenance_date, " +
    ...
    public static Map<String, Object> getBusUtilizationReport(int year, int month) {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            String query = "SELECT b.bus_id, b.bus_number, " +
