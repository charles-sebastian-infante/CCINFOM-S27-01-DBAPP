...
public class ReportController extends HttpServlet {
    ...
    private void tripScheduleReportForm(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("reportType", "tripSchedule");
            request.getRequestDispatcher("/admin/manage_reports.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void generateTripScheduleReport(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Generate report for all terminals
            Map<String, Object> reportData = ReportService.getDailyScheduleAllTerminals(date);
