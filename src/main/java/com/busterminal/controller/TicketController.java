    ...
    private void showEditForm(HttpServletRequest request,
        ...
        try {
            ...
            if (ticket.getRecord() == 1){
                ...
                ticketMap.put("ticket_id", ticket.ticketID);
                ticketMap.put("ticket_number", ticket.ticketNumber);
                ticketMap.put("schedule_id", ticket.scheduleID);
                ticketMap.put("discounted", ticket.discounted);

                request.setAttribute("editTicket", ticketMap);  // ← FIXED
