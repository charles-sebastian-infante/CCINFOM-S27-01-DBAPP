...
-- =====================================================
INSERT INTO Bus (bus_number, capacity, status, current_terminal) VALUES
-- Manila terminal buses
('MAM-1001', 45, 'Scheduled', 1),
('MAM-1002', 45, 'Available', 1),
('MAM-1003', 50, 'Scheduled', 1),
('MAM-1004', 45, 'In Transit', 1),
('MAM-1005', 40, 'Available', 1),
('MAM-1006', 50, 'Scheduled', 1),

-- Provincial terminal buses
('MAM-2001', 45, 'In Transit', 2),
('MAM-2002', 40, 'Available', 2),
('MAM-3001', 40, 'Maintenance', 3),
('MAM-3002', 45, 'Available', 3),
('MAM-4001', 45, 'Scheduled', 4),
('MAM-5001', 50, 'Available', 5),
('MAM-6001', 45, 'Scheduled', 6),
('MAM-7001', 45, 'In Transit', 7),
('MAM-8001', 50, 'Scheduled', 8),
('MAM-8002', 45, 'Available', 8),
('MAM-9001', 40, 'Scheduled', 9),
('MAM-10001', 45, 'Available', 10),
('MAM-1007', 45, 'Available', 1),
('MAM-1008', 50, 'Maintenance', 1);

-- =====================================================
-- 4.0 SCHEDULE DATA
-- Bus schedules for today and upcoming trips
-- =====================================================
INSERT INTO Schedule (bus_id, route_id, departure_time, arrival_time, status) VALUES
-- Scheduled trips
(1, 1, '2025-10-27 08:00:00', '2025-10-27 11:30:00', 'Scheduled'),
(2, 2, '2025-10-27 09:00:00', '2025-10-27 11:30:00', 'Scheduled'),
(3, 5, '2025-10-27 06:00:00', '2025-10-27 14:00:00', 'Scheduled'),
(6, 9, '2025-10-27 07:30:00', '2025-10-27 12:30:00', 'Scheduled'),
(11, 11, '2025-10-27 10:00:00', '2025-10-27 11:00:00', 'Scheduled'),
(13, 18, '2025-10-27 09:30:00', '2025-10-27 17:30:00', 'Scheduled'),
(15, 17, '2025-10-27 05:00:00', '2025-10-27 11:00:00', 'Scheduled'),
(17, 15, '2025-10-27 08:00:00', '2025-10-27 10:00:00', 'Scheduled'),

-- Departed trips
(4, 7, '2025-10-27 05:10:00', '2025-10-27 11:00:00', 'Departed'),
(7, 16, '2025-10-27 07:05:00', '2025-10-27 10:30:00', 'Departed'),
(14, 19, '2025-10-27 06:35:00', '2025-10-27 16:30:00', 'Departed'),

-- Completed trips
(1, 1, '2025-10-26 08:05:00', '2025-10-26 11:45:00', 'Completed'),
(2, 2, '2025-10-26 14:10:00', '2025-10-26 16:40:00', 'Completed'),
(15, 17, '2025-10-25 05:00:00', '2025-10-25 11:15:00', 'Completed'),

-- Cancelled trip
(19, 14, '2025-10-27 12:00:00', '2025-10-27 14:00:00', 'Cancelled'),

-- Future schedules
(1, 1, '2025-10-27 14:00:00', '2025-10-27 17:30:00', 'Scheduled'),
(2, 2, '2025-10-27 15:00:00', '2025-10-27 17:30:00', 'Scheduled'),
(5, 8, '2025-10-28 06:00:00', '2025-10-28 12:00:00', 'Scheduled'),
(6, 9, '2025-10-28 07:00:00', '2025-10-28 12:00:00', 'Scheduled'),
(8, 12, '2025-10-28 08:00:00', '2025-10-28 13:30:00', 'Scheduled');
